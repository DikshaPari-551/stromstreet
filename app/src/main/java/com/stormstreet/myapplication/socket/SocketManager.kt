package com.stormstreet.myapplication.socket
import android.content.Context
import android.os.Handler
import android.os.Looper
import android.util.Log
import com.stormstreet.myapplication.entity.Response.Chalist
import com.stormstreet.myapplication.entity.Response.Chatlist
...
import com.stormstreet.myapplication.entity.Service_Base.ServiceConstant
    ...
    init {
        try {
          ...
          //  socket = IO.socket("http://172.16.2.19:3027")
           socket = IO.socket(ServiceConstant.BASE_SOCKET_URL)
