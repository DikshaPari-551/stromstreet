...
//            player.setPlaybackSpeed(speed);
    ...
    private void newPlayer() {
       ...
       // player.addListener((Player.EventListener) eventLogger);
        ...
        switch (type) {
            case C.TYPE_SS:
                return new SsMediaSource(uri, new DefaultDataSourceFactory(playerUI.getContext(), userAgent),
                        new DefaultSsChunkSource.Factory(mediaDataSourceFactory), mainHandler, (MediaSourceEventListener) eventLogger);
            case C.TYPE_DASH:
                return new DashMediaSource(uri, new DefaultDataSourceFactory(playerUI.getContext(), userAgent),
                        new DefaultDashChunkSource.Factory(mediaDataSourceFactory), mainHandler, (MediaSourceEventListener) eventLogger);
           /* case C.TYPE_HLS:
                return new HlsMediaSource(uri, mediaDataSourceFactory, mainHandler, eventLogger);
           */ case C.TYPE_OTHER:
                return new ExtractorMediaSource(uri, mediaDataSourceFactory, new DefaultExtractorsFactory(),
                        mainHandler, (ExtractorMediaSource.EventListener) eventLogger);
            default: {
