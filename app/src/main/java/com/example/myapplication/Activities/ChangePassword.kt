...
class ChangePassword : AppCompatActivity(), ApiResponseListener<Responce> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        new_password = findViewById(R.id.old_password)
        re_enter_passeord = findViewById(R.id.changepassword)
